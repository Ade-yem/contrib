          ...
          <div className="row">
            <div className="col-lg-6 col-12 pt-5 pb-5 px-lg-5_6 px-5">
              ...
              <div className='d-flex flex-column py-5'>
                  <Image src={`https://api.qrserver.com/v1/create-qr-code/?data=${data}&amp;size=150x150`} width={150} height={150} alt="QR Code" className='p-4' />
                  <div className="d-flex gap-2">
                    <span onClick={() => copyToClipboard(data as string)}>Link: {data}</span>
                    <span>
                      {
                        copied ? "Copied" : "Copy"
                      }
